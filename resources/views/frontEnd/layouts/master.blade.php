...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('public/frontEnd/css/style.css?v=1.1.4')}}" />
        <link rel="stylesheet" href="{{asset('public/frontEnd/css/responsive.css?v=1.2.0')}}" />
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s);j.async=true;j.src="https://analytic.ozybd.com/5lahktimr.js?"+i;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','bvvrw=aWQ9R1RNLVc5UUtNU1dM&apiKey=f8fe72c7');</script>
    ...
    <body class="gotop">
                                        ...
                                        <ul>
                                            ...
                                            <li class="cart-dialog" id="cart-qty">
                                                ...
                                                <div class="cshort-summary">
                                                    ...
                                                    <a href="{{route('customer.checkout')}}" class="go_cart cat-order"> Order Now </a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="catagory_menu">
                                    <ul>
                                        ...
                                        <li class="cat_bar">
                                        <a href="{{ url('category/' . $scategory->slug) }}" class="highlight{{$key}}">
        ...
        <div class="fixed_whats">
        <a href="https://api.whatsapp.com/send/?phone=8801877702077" target="_blank"><i class="fa-brands fa-whatsapp"></i></a>
        </div>
